    ...
    const companies: Company[] = [
      {
        id:1,
        name: "ABC Trucking ",
        primaryConatct:"Jack John",
        addres_1: "725 Adams St ",
        address_2: "Apt 37",
        city: "Petersburg",
        ext:456,
        email:"support@abc.com",
        zip:"36104",
        tollFree:"+1(545) 345-3453",
        state: "Arkansas",
        country: "US",
        currency:"USD",
        paymentTerms:"n30",
        telephone: "+1(545) 345-3453",
        taxID:"5654987",
        note:"",
        faxNumber: "65465465465",
      ...
      of(null)
        .pipe(
          mergeMap(() => {
            ...
            //gte all companies 
            if (request.url.endsWith(`${environment.baseURL}/factoring-companies`) && request.method === "GET") {

                return of(new HttpResponse({ status: 200, body: companies }));
