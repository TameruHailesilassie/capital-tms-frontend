...
@NgModule({
  declarations: [WalletComponent, BuysellComponent, ExchangeComponent,
     LendingComponent, KycapplicationComponent,
      WalletSortableService, OrdersComponent, OrderSortableService],
  imports: [
    CommonModule,
    UIModule,
    CryptoRoutingModule,
